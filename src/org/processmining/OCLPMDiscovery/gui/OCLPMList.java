 ...
 * 
 */
public class OCLPMList<E> extends RoundedPanel {
	 ...
	 */
	@SuppressWarnings("rawtypes")
	public OCLPMList(final String title) {
		super(10, 5, 0);
		jList = new JList/* <E> */();
		setup(title);
	}
	...
	public OCLPMList(final String title, final ListModel/* <E> */providers) {
		super(10, 5, 0);
	...
	private void setup(final String title) {
		...
		final OCLPMScrollPane scroller = new OCLPMScrollPane(jList);
