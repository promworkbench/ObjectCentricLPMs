...
public class OCLPMTable extends RoundedPanel {
	 ...
	 * @param model
	 */
	public OCLPMTable(final TableModel model) {
		this(model, null);
	}

	public OCLPMTable(final TableModel model, final TableColumnModel columnModel) {
		this(model, columnModel, new OCLPMColors());
	}
	/**
	 * @param model
	 * @param columnModel
	 */
	public OCLPMTable(final TableModel model, final TableColumnModel columnModel, OCLPMColors theme) {
		super(10, 5, 0);
		...
		final OCLPMScrollPane scroller = new OCLPMScrollPane(table);
