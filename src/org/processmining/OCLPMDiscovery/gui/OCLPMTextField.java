 ...
 * ProMTextField with some changes...
 */
public class OCLPMTextField extends BorderPanel {
	...
	public OCLPMTextField() {
		...
		setMinimumSize(new Dimension(20, 30)); // default 200,30
		setMaximumSize(new Dimension(1000, 30)); // default 1000,30
		setPreferredSize(new Dimension(1000, 30)); // default 1000,30
	}

	/**
	 * @param initial
	 */
	public OCLPMTextField(final String initial) {
		this();
		setText(initial);
	}
	 ...
	 */
	public OCLPMTextField(final String initial, final String hint) {
		this();
		setText(initial);
		setHint(hint);
	}
